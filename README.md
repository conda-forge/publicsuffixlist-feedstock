About publicsuffixlist-feedstock
================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/publicsuffixlist-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/publicsuffixlist-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add publicsuffixlist
# for installing globally
pixi global install publicsuffixlist
```
...
It is possible to list all of the versions of `publicsuffixlist` available on your platform:
...
```
pixi search publicsuffixlist --channel conda-forge
```
